...
export const metadata: Metadata = {
  title: "Website Audit vs SEO Checker: What Each One Finds",
  description: "Compare a website audit with an SEO checker and see when you need technical checks, visitor clarity, or both.",
...
export default function AiWebsiteAuditVsSeoCheckerPage() {
  return <SeoIntentPage config={{
    ...
    eyebrow: "WEBSITE AUDIT / SEO CHECKER",
    title: "Website audit vs SEO checker: two different",
    emphasis: "questions.",
    description: "Compare a website audit with an SEO checker and see when you need technical checks, visitor clarity, or both.",
    ...
    answer: "An SEO checker and a rule-based website review answer different questions. SEO checks focus on crawlability, metadata, structure, and discoverability; a growth review focuses on offer clarity, trust, and the next visitor decision. Use both when traffic and conversion are separate problems.",
    checks: [
      ...
      { label: "02 / WEBSITE REVIEW", title: "Find decision friction in the page.", copy: "A rule-based review reads the offer, audience, proof, CTA, and page sequence. It points to the visible wording or structure behind each recommendation." },
    ...
    faq: [
      { question: "Is a website audit a replacement for an SEO checker?", answer: "No. They overlap on page content but serve different purposes. A technical SEO check helps search visibility; a growth review examines visitor understanding, trust, and action." },
