...
export const metadata: Metadata = {
  title: "Terms",
  description: "Terms for using SiteLens website reviews.",
  ...
  return (
    <main className="legal-page shell">
      ...
      <article className="legal-copy">
        ...
        <p>SiteLens provides qualitative website reviews based on the submitted page and the context you provide. Public-beta reports are generated by deterministic page rules and include a structured score, findings, evidence, and suggested first changes. SiteLens does not promise a conversion lift, search ranking, revenue result or business outcome.</p>
        ...
        <h2>Public-beta access</h2>
        <p>SiteLens is currently free to use. No subscription, checkout, or email submission is required to view a report. SiteLens may introduce or change access terms in a future version, but the current public-beta experience does not charge for analysis.</p>
        <h2>Availability</h2>
        ...
        <p>Do not overload the service, automate requests beyond the published limits, attempt to access another user&apos;s report, or use the service for unlawful activity.</p>
      </article>
