  ...
  return (
    <main className="teardown-page review-page">
      ...
      <section className="teardown-action-plan shell" aria-label="Decision guides">
        <article><span>DIAGNOSE</span><h3>Find the reason before adding traffic</h3><p>Start with common website and SaaS conversion gaps, then inspect category, proof, and CTA fit on your own homepage.</p><Link className="text-link" href="/why-websites-dont-convert">Why websites do not convert ↗</Link><Link className="text-link" href="/why-saas-websites-dont-convert">Why SaaS sites do not convert ↗</Link><Link className="text-link" href="/saas-homepage-audit">Audit a SaaS homepage ↗</Link></article>
