...
这组截图用于第三方产品页、社区反馈帖和人工合作沟通，展示 SiteLens 当前真实可访问的产品流程。

## 文件

| 文件 | 用途 |
| --- | --- |
| `01-homepage.png` | 首页、免费分析入口和产品能力说明 |
| `02-report-flow.png` | 分析完成后的证据型报告和问题列表 |
...
1. 使用真实平台账号，按社区规则逐个平台定制文案。
2. 使用对应渠道的 UTM 链接，不重复发布相同内容。
3. 发布后用 GA4 的 Active users、落地页和 `analyze_completed` 复核质量。
